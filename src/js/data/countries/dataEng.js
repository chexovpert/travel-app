...
export const dataEng = [
  {
    ...
    about:
      "Spain, with its beautiful beaches along the western Mediterranean, lively nightlife, many cultural regions and ancient cities, is a great place to travel.",
    aboutFull: [
  ...
  },
  {
    ...
    about:
      "Italy is a large state in the south of Europe. There is a huge number of world heritage sites protected by UNESCO - historical monuments and works of art are located throughout the country.",
    aboutFull: [
  ...
  },
  {
    ...
    about:
      "France is a state of Western Europe, which includes, among other things, the islands of Corsica, Saint-Pierre, Miquelon, the Antilles, Reunion and French Guiana, French Polynesia, New Caledonia, Wallis and Futuna islands.",
    aboutFull: [
  ...
  },
  {
    ...
    about:
      "Portugal, or the Portuguese Republic (República Portuguesa), is the westernmost state in continental Europe, occupying the southwest of the Iberian Peninsula, whose coast is washed by the Atlantic Ocean.",
    aboutFull: [
  ...
  },
  {
    ...
    about:
      "The replicated image of the country of all-inclusive hotels has long been far from the truth. Turkey is rich not only in history, but also in a variety of climatic and unique natural sites.",
    aboutFull: [
  ...
  },
  {
    ...
    about:
      "The Republic of Indonesia is the largest state in Southeast Asia and also the largest island state in the world. The extreme points of the country in the west and east are at a distance of 5150 km from each other.",
    aboutFull: [
  ...
  },
  {
    ...
    about:
      'Thailand is a Southeast Asian country located in the southwestern part of the Indochina Peninsula and in the northern part of the Malacca Peninsula. Until 1939 it was called "Siam" in Thai means "freedom".',
    aboutFull: [
  ...
  },
  {
    ...
    about:
      'The Japanese call their country "Nippon" or "Nihon", and the first option is official (banknotes, postage stamps, etc.), the second is household. The inhabitants of Japan call themselves "nihonzin", and their language - "nihongo"',
    aboutFull: [
